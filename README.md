...
To install this tool on your own Google Sheet before it is available on the Google Workspace Marketplace(Working on it):
...
6. For styling, add the Stylesheet.html. It looks nicer, but it's optional.
7. Save the project (Ctrl+S / Cmd+S).
8. Refresh your Google Sheet. You will now see a new menu item called **Auto-Fill Rules** near the Help tab.
